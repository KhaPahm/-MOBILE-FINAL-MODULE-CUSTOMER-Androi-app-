...
public class Item_noodles_Adapter extends RecyclerView.Adapter<Item_noodles_Adapter.ViewHolder>{
    private ArrayList<Item_food_fragment> listitems;
    private Context context;

    public Item_noodles_Adapter(ArrayList<Item_food_fragment> items, Context context)
    {
