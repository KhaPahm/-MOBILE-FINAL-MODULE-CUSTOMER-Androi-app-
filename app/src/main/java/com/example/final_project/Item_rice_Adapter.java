...
public class Item_rice_Adapter extends RecyclerView.Adapter<Item_rice_Adapter.ViewHolder>{
    private ArrayList<Item_food_fragment> listitems;
    private Context context;

    public Item_rice_Adapter(ArrayList<Item_food_fragment> items, Context context)
    {
